...
if(array_key_exists('userLogin', $_SESSION)){//a mettre devant la ligne concernée
   ...
   <!-- <?php if($_SESSION['userLevel'] == 'admin'){
       //echo '<a href= 'index.php?objet=post&action=create'>Ecrire un nouveau chapitre</a>'
   }       
    ?> -->
    <table>
        <tbody>
            <?php foreach($posts as $post) { ?>
                <tr>
                    ...
                    <td><?php if($_SESSION['userLevel'] == 'admin'){
                        echo '<a href="index.php?objet=post&action=modify&id=<?php echo $post->getId(); ?>" title="modifier <?php echo $post->getTitle(); ?> - <?php echo $post->getId(); ?>">Modifier</a></td>
